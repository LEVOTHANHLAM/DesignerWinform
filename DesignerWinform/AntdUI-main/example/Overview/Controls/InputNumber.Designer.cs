...
namespace Overview.Controls
{
    partial class InputNumber
    {
        ...
        private void InitializeComponent()
        {
            ...
            input1.Maximum = new decimal(new int[] { 10, 0, 0, 0 });
            input1.Name = "input1";
            ...
            input2.Maximum = new decimal(new int[] { 10, 0, 0, 0 });
            input2.Minimum = new decimal(new int[] { 1, 0, 0, 0 });
            input2.Name = "input2";
            ...
            input4.Maximum = new decimal(new int[] { 1000000, 0, 0, 0 });
            input4.Name = "input4";
            input4.Radius = 0;
